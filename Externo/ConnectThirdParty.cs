...
//using Configuration = CyberSource.Client.Configuration;

namespace apiBillFold.Externo
{
	public class ConnectThirdParty
	{
    /*    public IConfiguration _configuration;
		public ConnectThirdParty(IConfiguration configuration)
		{
        ...
        public static PtsV2PaymentsPost201Response Run()
        {
            ...
            string orderInformationAmountDetailsCurrency = "GTQ";
            ...
            string orderInformationBillToPostalCode = "10015";
            string orderInformationBillToCountry = "GT";
            string orderInformationBillToEmail = "bmwrjo@gmail.com";
            ...
            try
            {
                var configuraciones = new Configuration();
               // var configDictionary = configuraciones.get;
