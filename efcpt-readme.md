...
1. Register your DbContext class in your "Program.cs" file.
    ...
    ```csharp
    builder.Services.AddDbContext<BilleteraCMContext>(
...
2. Add "ConnectionStrings" to your configuration file (secrets.json, appsettings.Development.json or appsettings.json).
    ...
    {
        "ConnectionStrings": {
            "DefaultConnection": "data source=serviciosfmdbserver.database.windows.net;initial catalog=ServiciosFM_db;trust server certificate=True;command timeout=300"
        }
    }
    ```
